...
.. code-block:: bash
    ...
    #  using conda
    conda create -n ogo -c numerics88 -c simpleitk -c conda-forge python=3 n88tools matplotlib pbr nose six simpleitk pydicom gdcm pandas statsmodels    #or python=2
