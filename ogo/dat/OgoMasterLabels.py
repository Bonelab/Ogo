...
labels_dict = {
    ...
    7: {'RGB': [  151,  221,   37], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'L4', 'TOTSEG': 'vertebrae_L4'},
    8: {'RGB': [  205,    0,   41], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'L3', 'TOTSEG': 'vertebrae_L3'},
    9: {'RGB': [   62,  146,  205], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'L2', 'TOTSEG': 'vertebrae_L2'},
   10: {'RGB': [  230,  135,    9], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'L1', 'TOTSEG': 'vertebrae_L1'},
  ...
  183: {'RGB': [  135,  128,  242], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'Trochanter Left', 'TOTSEG': 'empty'},
  185: {'RGB': [  161,  221,  244], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'Shaft Right', 'TOTSEG': 'empty'},
  183: {'RGB': [  100,  149,  237], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'Shaft Left', 'TOTSEG': 'empty'},
