...
labels_dict = {
  ...
  167: {'RGB': [   145,  247, 225], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'L2 Body', 'TOTSEG': 'empty'},
  ...
  179: {'RGB': [   226,  86,  173], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'Upper Femoral Neck Left', 'TOTSEG': 'empty'},
  180: {'RGB': [  173,   29,  118], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'Lower Femoral Neck Right', 'TOTSEG': 'empty'},
  181: {'RGB': [  196,    49, 206], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'Lower Femoral Neck Left', 'TOTSEG': 'empty'},
  182: {'RGB': [  255,  132,    2], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'Trochanter Right', 'TOTSEG': 'empty'},
  183: {'RGB': [   153,   46,   1], 'A': 1.0, 'VIS': 1, 'IDX': 1, 'LABEL': 'Trochanter Left', 'TOTSEG': 'empty'},
