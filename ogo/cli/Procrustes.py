    ...
    for input_image in input_filenames:
        ...
        for idx in range(n_labels):
            ...
            if label in label_list:
                ...
                print('  {:8d} {:8d} {:8.3f} {:8.3f} {:8.3f} {}'.format(label,n_pixels,centroid[0],centroid[1],centroid[2],labelsDict[label]['LABEL']))
...
'''
    ...
    parser.add_argument('--label_list', type=int, nargs='*', default=None, metavar='ID', help='Specify which labels to analyze; space separated (e.g. 1 2 3) (default: all)')
    parser.add_argument('--sensitivity', type=float, default=0.01, metavar='VAL', help='Sensitivity to trigger warning (default: %(default)s)')
