...
def internal(input_image, input_mask, output_image, calib_file_name, MonteCarlo, useLabels, useL4, overwrite, func):
    ...
    if MonteCarlo:
        ...
        calib = InternalCalibration(
            ...
            adipose_std = labels_data['Adipose']['stdev'], 
            air_std = labels_data['Air']['stdev'],
            blood_std = labels_data['Blood']['stdev'], 
        ...
        ogo.message('  {:>27s} {:8.1f}'.format('Variance ', imfilt.GetVariance()))
        ogo.message('  {:>27s} {:8.1f}'.format('StdDev ', np.sqrt(imfilt.GetVariance())))
        imfilt.Execute(uncertainty)
        ogo.message('  {:>27s} {:s}'.format('Standard Error Image Information:', ''))
        ogo.message('  {:>27s} {:8.1f}'.format('Minimum ', imfilt.GetMinimum()))
        ogo.message('  {:>27s} {:8.1f}'.format('Maximum ', imfilt.GetMaximum()))
        ogo.message('  {:>27s} {:8.1f}'.format('Mean ', imfilt.GetMean()))
        ogo.message('  {:>27s} {:8.1f}'.format('Variance ', imfilt.GetVariance()))
