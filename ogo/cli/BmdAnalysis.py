...
# Start Script
def BMDAnalysis(image_filename, mask_filename, labels, output_filename, noheader, overwrite=False):
...
ogoBMDAnalysis Test_QCT_IntCalib.nii Test_QCT_IntCalib_CORR.nii.gz >> output.txt

# Write to specified file:
ogoBMDAnalysis Test_QCT_IntCalib.nii Test_QCT_IntCalib_CORR.nii.gz --output_filename output.txt

# Specify specific labels for L1 ot L4 to analyze:
ogoBMDAnalysis Test_QCT_IntCalib.nii Test_QCT_IntCalib_CORR.nii.gz --output_filename output.txt --labels 7 8 9 10
...
'''
    ...
    if args.output_filename:
        print(echo_arguments('BMDAnalysis', vars(args)))

    # Run program
    BMDAnalysis(**vars(args))
