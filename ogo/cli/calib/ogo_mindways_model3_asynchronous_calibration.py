...
##
# Start Script
def mindwaysModel3AsyncCalib(args):
...
def main():
     # Setup description
    description='''
This script performs asynchronous density calibration for an input image and input phantom image using an input mask of the density calibration rods. 
This script is only compatible with the Mindways Model 3 CT phantom. 

INPUT: Image (as Dicom or NIFTI), Calibration Phantom Image (Dicom or NIFTI), and Calibration Mask (as Dicom or NIFTI) 
OUTPUT: K2HPO4 Density Calibrated Image (NIFTI), Text file of Calibration Parameters and associated information
...
'''
    ...
    print(echo_arguments('ogoMindways_Model3_Asynchronous_Calibration', vars(args)))

    # Run program
    mindwaysModel3AsyncCalib(args)
