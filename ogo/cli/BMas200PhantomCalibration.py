...
This script performs phantom-based density calibration for an input image using an input mask of the density calibration rods. 
This script is only compatible with the B-MAS 200 CT phantom. INPUT: Image (as Dicom or NIFTI), Calibration Mask (as Dicom or NIFTI) 

OUTPUT: CHA Density Calibrated Image (NIFTI), Text file of Calibration Parameters and associated information
...
'''
    ...
    print(echo_arguments('ogoB_Mass200_Phantom_Calib', vars(args)))

    # Run program
    ogoBMassPhantomCalib(args)
