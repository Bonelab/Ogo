...
def IsotropicResampling(input_filename, output_filename, iso_resolution, image_type, overwrite=False):
    ...
    output = ogo.isotropicResampling(image, iso_resolution, image_type)
...
'''
    ...
    parser.add_argument('--iso_resolution', type=float, default=1.0, metavar='DIM',
                        help='Isotropic resolution (default: %(default)s)')
    parser.add_argument('--image_type', default='ct', choices=['ct', 'mask'],
                        help='Specify CT or mask input (default: %(default)s)')
