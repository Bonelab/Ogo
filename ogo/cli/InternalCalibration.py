...
def main():
     # Setup description
    description='''
This script performs internal density calibration for an input image using an input calibration mask of the reference tissues. 
The reference tissues required in the mask with values are 1 = Adipose, 2 = Air, 3 = Blood, 4 = Cortical Bone, 5 = Skeletal Muscle. 
