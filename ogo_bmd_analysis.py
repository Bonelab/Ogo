...
parser = argparse.ArgumentParser(
    description="""This script performs BMD analysis from an input calibrated image and a bone mask. This script outputs a text file containing the BMD analysis results. INPUT: Calibrated Image (as NIFTI), Bone Mask (as NIFTI) OUTPUT: Text file of BMD analysis and associated information.""")
